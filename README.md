...
└── infrastructure/           # AWS infrastructure configurations
    ...
    ├── nginx_config_ksh     # Nginx server configurations
```
...
13. Create the Launch Template for Frontend Server
14. Create the Launch Template for Backend Server
15. Create the Auto Scaling Group for Frontend Server
16. Create the Auto Scaling Group for Backend Server
